  ...
  Map<String, dynamic> toJson({
    ...
    bool withPhoto = true,
      ...
      Map<String, dynamic>.from({
        ...
        'isStarred': isStarred,
        'name': name.toJson(),
        'phones': phones.map((x) => x.toJson()).toSet().toList(),
        'emails': emails.map((x) => x.toJson()).toSet().toList(),
        ...
        'notes': notes.map((x) => x.toJson()).toSet().toList(),
        'accounts': accounts.map((x) => x.toJson()).toSet().toList(),
        'groups': groups.map((x) => x.toJson()).toSet().toList(),
      });
